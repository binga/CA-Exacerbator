...
# A, paths
train = 'Train_Scaled_Shuffled.csv'               # path to training file
test = 'testFull.csv'                 # path to testing file
submission = 'submission_pypy.csv'  # path of to be outputted submission file
